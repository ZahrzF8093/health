...
jQuery(function ($) {
  $(document).on("click", ".submit", function () {
    ...
    if (gender == "female" && age == "age1" && goal == "goal2") {
      $(".ex1").text(
        "دویدن تقریباً ساده ترین شکل ورزش است و برای انرژی به ظاهر بی پایان و نیاز شما به سرعت عالی است. می توانید در فضای باز یا داخل خانه بدوید. هر جایی بین 10 تا 20 دقیقه در روز برای رسیدن به هدفتان کافی است!!"
      );
      $;
    ...
    if (gender == "female" && age == "age2" && goal == "goal1") {
      ...
      $(".exh1").text("جک های پرش");
      $(".ex1").text(
        "جک جامپینگ به شما انعطاف می دهد و به شما کمک می کند استقامت را افزایش دهید. پاهای خود را کنار هم نگه دارید و قد بلند بایستید و دست ها را صاف در کناره ها نگه دارید. در حین پریدن، بازوهای خود را بالای سر و پاهای خود را از هم جدا کرده و به طرفین ببرید. به سرعت به عقب برگردید و با یک پرش به حالت ایستاده برگردید. یک یا دو دقیقه تمرینات جک پرش می تواند عضلات شما را با جریان بیشتر اکسیژن در جریان خون شل کند."
      );
      $(".exi1").attr("src", "../assets/jumpjack.jpg");
      $(".exh2").text("بلند کردن پا ");
      $(".ex2").text(
        "تمرینات بالا بردن ساق پا یکی از بهترین تمرینات برای نواحی شکم است. شما فقط باید به پشت دراز بکشید، دستان خود را در کنار خود قرار دهید، کف دست ها را پایین بیاورید. پاهای خود را از زمین بلند کنید و زانوهای خود را قفل نگه دارید. تا جایی که راحت می توانید وضعیت را نگه دارید و سپس به آرامی به حالت اولیه بازگردید."
      );
